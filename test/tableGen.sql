CREATE TABLE IF NOT EXISTS tande3 (
...
INSERT INTO tande3 (`id`, `items`, `x`) VALUES ('abc', (1, 'John', 'good',0), 'hello'), ('edf', (2, 'Kanade', 'bad', 7),'world'), ('xyz', (10, 'Emilia', 'violent', 55),'hello'), ('uvw', (20, 'rem', 'waifu', -12),'world')
